...
class transportCarTest {
    ...
    void shouldLoadOnWhenSpaceAvailable() {
        ...
        TransportCar transportCar = new TransportCar(4, Color.WHITE, 90, "charge", 0, 10, 0, 0,0,3);
        Saab95 saab = new Saab95(2, Color.WHITE, 125, "Saab95", 0,10, 0,0,0);
    ...
    void shouldLoadOffWhenSpaceAvailable() {
        ...
        TransportCar transportCar = new TransportCar(4, Color.WHITE, 90, "charge", 0, 10, 0, 0,0,3);
        Saab95 saab = new Saab95(2, Color.WHITE, 125, "Saab95", 0,10, 0,0,0);
        Saab95 saab2 = new Saab95(2, Color.WHITE, 125, "Saab95", 0,10, 0,0,0);
        transportCar.lowerRamp();
        transportCar.loadOn(saab);
